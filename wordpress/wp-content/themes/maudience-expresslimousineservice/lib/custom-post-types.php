...
*/
     ...
     **/
	    ...
	    add_action( 'init', ma_custom_post_type_creator('Services', 'Holds our data specific to our services', true, 5, array( 'title', 'editor', 'thumbnail' ), true, false));
	 ...
	 */
		...
		function ma_meta_box_callback1( $post ) {
	 ...
	 */
		...
		function ma_save_meta_box_data( $post_id ) {
		    ...
		    if ( ! isset( $_POST['ma_new_field1'] ) || ! isset( $_POST['ma_new_field2'] ) ) {
		        return;
		    }
